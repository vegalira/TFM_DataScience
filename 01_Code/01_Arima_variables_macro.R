...
renta <- read_xlsx("..\\00_Data\\Serie_temporal_Renta_Distritos_Ayto.xlsx")
...
for (i in 3:length(cabeceras)){
  ...
  write.table(cabeceras[i], file = "..\\02_Ouput\\01_predicciones_macro\\prediccion_renta.xls", append=TRUE)
  write.table(prediccion, file = "..\\02_Ouput\\01_predicciones_macro\\prediccion_renta.xls", append=TRUE)
}
...
compraventas <- read_xlsx("..\\00_Data\\Serie_temporal_Compraventas_Distritos_Ayto.xlsx")
...
for (i in 3:length(cabeceras)){
  ...
  #print(prediccion)
  #plot(forecast(fitARIMA, h=5), incluide=150)
  write.table(cabeceras[i], file = "..\\02_Ouput\\01_predicciones_macro\\prediccion_compraventas.xls", append=TRUE)
  write.table(prediccion, file = "..\\02_Ouput\\01_predicciones_macro\\prediccion_compraventas.xls", append=TRUE)
}
...
inmuebles <- read_xlsx("..\\00_Data\\Serie_temporal_Inmuebles_Distritos_Ayto.xlsx")
...
for (i in 3:length(cabeceras)){
  ...
  #print(prediccion)
  #plot(forecast(fitARIMA, h=5), incluide=150)
  write.table(cabeceras[i], file = "..\\02_Ouput\\01_predicciones_macro\\prediccion_inmuebles.xls", append=TRUE)
  write.table(prediccion, file = "..\\02_Ouput\\01_predicciones_macro\\prediccion_inmuebles.xls", append=TRUE)
}
...
parados <- read_xlsx("..\\00_Data\\Serie_temporal_Parados_Distritos_Ayto.xlsx")
...
for (i in 3:length(cabeceras)){
  ...
  #print(prediccion)
  #plot(forecast(fitARIMA, h=5), incluide=150)
  write.table(cabeceras[i], file = "..\\02_Ouput\\01_predicciones_macro\\prediccion_parados.xls", append=TRUE)
  write.table(prediccion, file = "..\\02_Ouput\\01_predicciones_macro\\prediccion_parados.xls", append=TRUE)
}
